...
class ASRModel:
    ...
    def __init__(self, config):
        ...
        '''
        self.config = config
        self.model = EncoderDecoderASR.from_hparams(source="speechbrain/asr-wav2vec2-commonvoice-en", savedir="pretrained_models/asr-wav2vec2-commonvoice-en",run_opts={"device":self.config["model"]["device"]})
